...
function setup() {
  ...
  ground2 = new Ground(490,300,260,10);
  ...
  block2 = new Block(550,275,30,40);
...
fill("green");
 ...
 textSize(25);
text("Drag the hexagon and release it to HIT THE BOXES",300,30);
text("Press SPACEBAR to reattach it",380,550);
